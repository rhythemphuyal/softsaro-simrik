...
@section('body')
    <div class=" bg-background w-full">
        ...
        <div class="flex justify-between">
            ...
            <a href='{{ route('gallerysection.create') }}'>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 text-center">
                            <tr>
                                ...
                                <td class="p-2" style="width: 100px;">
                                    <img class="" src="{{ asset('uploads/' . $datas->image) }}" alt="Card"
                                        style="width: 70px;">
                                </td>
                                ...
                                <td>
                                    <div class="flex p-2 justify-center">
                                        <a href="{{ route('gallerysection.edit' , $datas->id) }}">
                                        ...
                                        <form method="POST" action="{{ route('gallerysection.destroy', $datas->id) }}"
