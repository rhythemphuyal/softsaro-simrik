<div class="w-full h-[15vh] relative flex">
    <img src={{ asset('/cooperativeimages/2.jpg') }} class="w-full h-full" />

    <div class="absolute flex items-center justify-between w-full px-4 border max-sm:p-2">

        <div class="pl-2">
            <h1 class="text-green-500 font-bold max-sm:text-[15px] text-3xl">Simrik Cooperative Limited</h1>
        </div>
        ...
        <div class="flex flex-col items-end justify-end gap-2 pr-2">
            <div class="relative w-[16vw] max-sm:w-[35vw] mt-1">

                <input type="text" name="search" id="search" placeholder="Search"
                    class="placeholder-green-700 border border-black rounded-full h-9">
                <button type="submit" class="absolute top-0 right-0 px-3 bg-black rounded-full h-9"><span
                        class="pt-1 text-white material-symbols-outlined">
                        search
                    </span>
                </button>
