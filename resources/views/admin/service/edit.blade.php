            ...
            <div class="p-6 mt-3">
                <div class="flex flex-col">
                    <div>
                        ...
                        <div>
                            <x-admin.component.input-field name="title" inputType="text" value="{{$services->title}}" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div>
                            <x-admin.component.input-field name="service_order" inputType="text" value="{{$services->service_order}}" />
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <x-admin.component.input-field name="service_image" inputType="file" ids="output" value="{{$services->service_image}}" />
