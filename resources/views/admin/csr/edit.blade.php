...
@section('body')
    <div class="flex gap-2 items-center">
        ...
        <div class="text-xl font-bold">Edit Csr</div>
    </div>
    <div class="mt-30 bg-white w-full rounded-lg shadow-lg text-slate-600">
        <form method="post" action="{{route('csr.update', $datas->id) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="p-6  mt-3">
                <div class="flex flex-col">
                    ...
                    <div>
                        ...
                        <div>
                            <x-admin.component.textarea class="tinymce" name="description" value="{{ $datas->description }}"  inputType="text" />                        </div>
                            </div>
                    </div>
