...
@section('body')
    <div class="w-full bg-background">
        ...
        <div class="flex justify-between">
            <div class="text-2xl font-bold">Types</div>
                    ...
                    @foreach ($data as $key => $datas)
                        <tbody class="text-center bg-white divide-y divide-gray-200">
                            <tr>
                                ...
                                <td class="">
                                    <div>{{ $datas->getScheme->title }}</div>
                                </td>
                                <td class="">
                                    <div>{{ $datas->getService->title }}</div>
                                </td>
                                ...
                                <td>
                                    <div class="flex justify-center p-2">
                                        <a href="{{ route('schemes.edit', $datas->id) }}">
                                        ...
                                        <form method="POST" action="{{ route('schemes.destroy', $datas->id) }}"
