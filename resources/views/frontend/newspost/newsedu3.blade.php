...
<div class="bg-gray-200">
    <div class="h-[30vh] w-full relative flex justify-center items-center">
        ...
        <h1 class="absolute text-white font-bold text-[40px]">Member Education Program Held on Lalitpur</h1>
    ...
    <div class=" ">
            ...
            <div class="flex items-center justify-end">
                    <button class="bg-green-500 hover:bg-blue-300 text-white font-bold px-2 py-2 rounded focus:outline-none focus:shadow-outline text-sm" type="submit">Post Comment</button>
            </div>
                </form>
                </div>
