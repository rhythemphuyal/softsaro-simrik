<div>
    <div class="pt-20 px-10 flex items-center gap-2">
    ...
    <div class="grid grid-cols-3 gap-10 max-sm:gap-0">
        <p class="px-20 max-sm:px-10 pt-10 text-[20px] col-span-2 max-sm:text-[15px]">We offer a wide range of deposit
            products
            that caters to your
            requirement. In order to expand community participation. Feel free to contact Us!</p>
        <div class="text-center flex justify-center py-5">
            <button id="hoverBtn" type="button" class="px-4 font-bold text-[20px] text-green-600">View All</button>
        </div>
    </div>
    ...
    <div class="swiper mySwiper h-[85vh]">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                ...
                <div class="shadow-lg border border-green-600 rounded-lg h-[54vh] bg-white ">
                    <div class=' rounded-md h-[35vh] w-full px-5 pt-5 '>
                        <img src="{{ asset('cooperativeimages/blog11.jpg') }}"
                            class="rounded-md h-full w-full object-cover">
                        <p class="pt-4 text-[15px] text-green-700 font-bold">Simrik</p>

                        <h1 class="pb-2 font-bold">Women Empowerment Program</h1>


                        <button type="submit" class=" float-right p-2 text-white bg-green-700 border rounded-md">Read
                            More</button>
                    </div>
            ...
            <div class="swiper-slide">
                <div class="shadow-lg border border-green-600 rounded-lg h-[54vh] bg-white">
                    <div class='rounded-md h-[35vh] w-full px-5 pt-5 '>
                        <img src="{{ asset('cooperativeimages/blog22.jpg') }}"
                            class="rounded-md h-full w-full object-cover">
                        <p class="pt-4 text-[15px] text-green-700 font-bold">Simrik</p>


                        <h1 class="pb-2 font-bold">25th Anniversary</h1>
            ...
            <div class="swiper-slide">
                <div class="shadow-lg border border-green-600 rounded-lg h-[54vh] bg-white">
                    <div class=' rounded-md h-[35vh] w-full px-5 pt-5 '>
                        <img src="{{ asset('cooperativeimages/blog33.jpg') }}"
                            class="rounded-md h-full w-full object-cover">
                        <p class="pt-4 text-[15px] text-green-700 font-bold">Simrik</p>


                        <h1 class="pb-2 font-bold">Inauguration Program</h1>
