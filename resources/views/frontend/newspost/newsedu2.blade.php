...
<div class="bg-gray-200">
    <div class="h-[30vh] w-full relative flex justify-center items-center">
        ...
        <h1 class="absolute text-white font-bold text-[40px]">Member Education Program Held on solukhumbu</h1>
            ...
            <div class="w-[60vw]">
                ...
                <div>
                    <a href="" class="block" role="button">
                      <img src="/cooperativeimages/edu2.jpg" alt="Image Description" class=" w-[70vw] h-[60vh]">
                    </a>
                </div>
                <div class="flex w-full pt-2">
                    ...
                    <div class="ml-2">
                       <h1 class=" pt-2 font-semibold italic text-lg text-black ">Member Education Program Held on Solukhumbu</h1>
