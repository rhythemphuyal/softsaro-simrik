...
@section('body')
    <div class="flex items-center gap-2">
        ...
        <div class="text-xl font-bold">Add Title</div>
    </div>
    <div class="w-full bg-white rounded-lg shadow-lg mt-30 text-slate-600">
        <form method="post" action="{{ route('schemes.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="p-6 mt-3">
                <div class="flex flex-col">
                    ...
                    <div>
                        ...
                        <div>
                            <x-admin.component.input-field name="order" inputType="text" />
                        </div>
                    </div>
